...
{
    /// <summary>
    /// Represents the Open Planar 3D Slicer class.
    /// </summary>
    [Serializable()]
    public class OpenPlanar3DSlicer : IProgram, ISlicer, IGeometry, IAddVariable
    {
        #region fields
        private Mesh _mesh ;
        ...
        #region constructors
        /// <summary>
        /// Initializes an empty instance of the Open Planar 3D Slicer class.
        /// </summary>
        public OpenPlanar3DSlicer()
        {

        }

        /// <summary>
        /// Initializes a new instance of the Open Planar 3D Slicer class from a list with absolute layer heights. 
        /// </summary>
        ...
        public OpenPlanar3DSlicer(Mesh mesh, double distance, bool reverse, IList<double> heights)
        {
            _mesh = mesh;
        ...
        /// <summary>
        /// Initializes a new instance of the Open Planar 3D Slicer class from a given number of layers and layer thickness.
        /// </summary>
        /// <param name="mesh"> The base mesh. </param>
        /// <param name="distance"> The desired distance between two frames. </param>
        ...
        public OpenPlanar3DSlicer(Mesh mesh, double distance, double height, bool reverse, int layers)
        {
            _mesh = mesh;
        ...
        /// <summary>
        /// Initializes a new instance of the Open Planar 3D Slicer class by duplicating an existing Open Planar 3D Slicer instance. 
        /// </summary>
        /// <param name="slicer"> The Open Planar 3D Slicer instance to duplicate. </param>
        public OpenPlanar3DSlicer(OpenPlanar3DSlicer slicer)
        {
        ...
        /// <summary>
        /// Returns an exact duplicate of this Open Planar 3D Slicer instance.
        /// </summary>
        /// <returns> The exact duplicate of this Open Planar 3D Slicer instance. </returns>
        public OpenPlanar3DSlicer Duplicate()
        {
            return new OpenPlanar3DSlicer(this);
        }

        /// <summary>
        /// Returns an exact duplicate of this Open Planar 3D Slicer instance as an IProgram.
        /// </summary>
        ...
        /// <summary>
        /// Returns an exact duplicate of this Open Planar 3D Slicer instance as an ISlicer.
        /// </summary>
        ...
        /// <summary>
        /// Returns an exact duplicate of this Open Planar 3D Slicer instance as an IGeometry.
        /// </summary>
        ...
        /// <summary>
        /// Returns an exact duplicate of this Open Planar 3D Slicer instance as an IAddVariable
        /// </summary>
        ...
        public void ToProgram(ProgramGenerator programGenerator)
        {
            ...
            // Sinumerik
            if (programGenerator.ProgramSettings.ProgramType == 0)
            {
            ...
            // Marlin
            else if (programGenerator.ProgramSettings.ProgramType == 1)
            {
                for (int i = 0; i < coordinates.Count; i++)
                {
                    programGenerator.Program.Add(" ");
        ...
        /// <summary>
        /// Returns the Open Planar 3D Slicer object as a string
        /// </summary>
