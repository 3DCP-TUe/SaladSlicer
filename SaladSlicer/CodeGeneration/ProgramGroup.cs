...
namespace SaladSlicer.CodeGeneration
{
    ...
    public class ProgramGroup : IProgram, IGeometry
    {
        ...
        protected ProgramGroup(SerializationInfo info, StreamingContext context)
        {
            // string version = (int)info.GetValue("Version", typeof(string)); // <-- use this if the (de)serialization changes
            _objects = (IList<IProgram>)info.GetValue("Objects", typeof(IList<IProgram>));
        }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("Objects", _objects, typeof(IList<IProgram>));
        }
        #endregion
