...
{
    /// <summary>
    /// Represents the GH_ClosedPlanar2DSlicer class.
    /// </summary>
    public class GH_ClosedPlanar2DSlicer : GH_GeometricGoo<ClosedPlanar2DSlicer>, IGH_PreviewData
    {
        #region (de)serialisation
        /// <summary>
        /// IO key for (de)serialisation of the value inside this Goo.
        /// </summary>
        private const string IoKey = "Closed Planar 2D Slicer";
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            Value = (ClosedPlanar2DSlicer)HelperMethods.ByteArrayToObject(array);
        ...
        #region constructors
        /// <summary>
        /// Initializes an empty instance of the GH_ClosedPlanar2DSlicer class.
        /// </summary>
        public GH_ClosedPlanar2DSlicer()
        {
            this.Value = null;
        }

        /// <summary>
        /// Initializes a new Oject Goo instance from a ClosedPlanar2DSlicer instance.
        /// </summary>
        /// <param name="closedPlanar2DSlicer"> ClosedPlanar2DSlicer Value to store inside this Goo instance. </param>
        public GH_ClosedPlanar2DSlicer(ClosedPlanar2DSlicer closedPlanar2DSlicer)
        {
            this.Value = closedPlanar2DSlicer;
        }

        /// <summary>
        /// Returns a complete duplicate of this Goo instance.
        /// </summary>
        /// <returns> A duplicate of the Closed Planar 2D Slicer Goo. </returns>
        public override IGH_Goo Duplicate()
        {
            if (this.Value == null)
            {
                return new GH_ClosedPlanar2DSlicer();
            }
            else
            {
                return new GH_ClosedPlanar2DSlicer(this.Value.Duplicate());
            }
        }
        ...
        public override string ToString()
        {
            if (this.Value == null)
            {
                return "Null Closed Planar 2D Slicer";
            }
            else
            {
        ...
        public override bool CastTo<Q>(ref Q target)
        {
            ...
            // Cast to ClosedPlanar2DSlicer Goo
            if (typeof(Q).IsAssignableFrom(typeof(GH_ClosedPlanar2DSlicer)))
            {
                target = (Q)(object)new GH_ClosedPlanar2DSlicer(this.Value);
                return true;
            }
        ...
        public override bool CastFrom(object source)
        {
            ...
            // Cast from ClosedPlanar2DSlicer
            if (typeof(ClosedPlanar2DSlicer).IsAssignableFrom(source.GetType()))
            {
                this.Value = source as ClosedPlanar2DSlicer;
                return true;
            }

            // Cast from ClosedPlanar2DSlicer Goo
            if (typeof(GH_ClosedPlanar2DSlicer).IsAssignableFrom(source.GetType()))
            {
                GH_ClosedPlanar2DSlicer goo = source as GH_ClosedPlanar2DSlicer;
            ...
            {
                if (source is ClosedPlanar2DSlicer slicer)
                {
                    this.Value = slicer;
                    return true;
                }
            ...
            if (typeof(GH_SlicerObject).IsAssignableFrom(source.GetType()))
            {
                ...
                if (goo.Value is ClosedPlanar2DSlicer slicer)
                {
                    this.Value = slicer;
                    return true;
                }
        ...
        public override string IsValidWhyNot
        {
            get
            {
                if (this.Value == null) { return "No internal Closed Planar 2D Slicer instance"; }
                if (this.Value.IsValid) { return string.Empty; }
                return "Invalid Closed Planar 2D Slicer instance.";
            }
        }
        ...
        {
            get { return "Defines a Closed Planar 2D Slicer."; }
        }
        ...
        {
            get { return "Closed Planar 2D Slicer"; }
        }
        #endregion
        ...
        public override IGH_GeometricGoo Transform(Transform xform)
        {
            ...
            {
                ClosedPlanar2DSlicer slicer = Value.Duplicate();
                slicer.Transform(xform);
                return new GH_ClosedPlanar2DSlicer(slicer);
            }
        }
