...
{
    /// <summary>
    /// Represents the Param_CurveSlicer class
    /// </summary>
    public class Param_CurveSlicer : GH_PersistentGeometryParam<GH_CurveSlicer>, IGH_PreviewObject
    {
        /// <summary>
        /// Initializes a new instance of the Param_Object class
        /// </summary>
        public Param_CurveSlicer()
          : base(new GH_InstanceDescription("Curve Slicer", // Parameter name
              "CS", // Component nickname
              "Defines a Curve Slicer object.", // Description
        ...
        {
            get { return Properties.Resources.Param_CurveSlicer_Icon; }
        }
        ...
        {
            get { return new Guid("82A56A4F-202A-4819-908D-AA22936FAFC2"); }
        }
        #endregion
        ...
        protected override GH_GetterResult Prompt_Plural(ref List<GH_CurveSlicer> values)
        {
        ...
        /// <returns> Canceled result. </returns>
        protected override GH_GetterResult Prompt_Singular(ref GH_CurveSlicer value)
        {
            return GH_GetterResult.cancel;
        }
