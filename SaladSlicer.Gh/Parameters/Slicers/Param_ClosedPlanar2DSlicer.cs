...
{
    /// <summary>
    /// Represents the Param_ClosedPlanar2DSlicer class
    /// </summary>
    public class Param_ClosedPlanar2DSlicer : GH_PersistentGeometryParam<GH_ClosedPlanar2DSlicer>, IGH_PreviewObject
    {
        /// <summary>
        /// Initializes a new instance of the Param_Object class
        /// </summary>
        public Param_ClosedPlanar2DSlicer()
          : base(new GH_InstanceDescription("Closed Planar 2D Slicer", // Parameter name
              "CP2D", // Component nickname
              "Defines a Closed Planar 2D Slicer object.", // Description
        ...
        {
            get { return Properties.Resources.Param_ClosedPlanar2DSlicer_Icon; }
        }
        ...
        {
            get { return new Guid("E8B35510-614A-467B-B516-8329996315FA"); }
        }
        #endregion
        ...
        protected override GH_GetterResult Prompt_Plural(ref List<GH_ClosedPlanar2DSlicer> values)
        {
        ...
        /// <returns> Canceled result. </returns>
        protected override GH_GetterResult Prompt_Singular(ref GH_ClosedPlanar2DSlicer value)
        {
            return GH_GetterResult.cancel;
        }
