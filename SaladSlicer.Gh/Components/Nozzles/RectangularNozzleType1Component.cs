...
namespace SaladSlicer.Gh.Components.Nozzles
{
    ...
    /// </summary>
    public class RectangularNozzleType1Component : GH_Component
    {
        #region fields
        #endregion
        ...
        /// </summary>
        public RectangularNozzleType1Component()
          : base("Rectangular Nozzle Type 1", // Component name
              "RecNozTy1", // Component nickname
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                ...
                // Result
                result = SaladSlicer.Nozzles.Nozzles.RectangularType1(boxWidth, boxDepth, filletRadius, length1, length2, length3, length4, outerDiameter, innerDiameter, nozzleWidth, nozzleHeight, divide);
            }
        ...
        {
            get { return Properties.Resources.RectangularNozzleType2_Icon; }
        }
